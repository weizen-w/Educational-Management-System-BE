...
-- table student_group
insert into student_group(group_name, course_id, archived, link_template)
values ('Group 1', 1, false,
        'https://raw.githubusercontent.com/ait-tr/cohort26/main/back_end/lesson_0x0/theory.md');
insert into student_group(group_name, course_id, archived, link_template)
...
-- table lesson
insert into lesson(group_id, lesson_title, lesson_description, lesson_type, teacher_id, lesson_date,
                   start_time, end_time, module_id, link_lms, link_zoom, archived)
values (1, 'basic_programming/lesson_52',
        'Smalltalk about homework Questions Binary seek in arrays', 'CONSULTATION', 1, '2023-11-27',
        '10:15:30', '12:15:30', 1,
        'https://lms.ait-tr.de/#/group/cohort26/module/basic_programming/lesson/lesson_52',
        'https://us05web.zoom.us/j/82073564366?pwd=LqOp9ojsiqseacSVwFPyt2jZA2tqUI.1', false);
insert into lesson(group_id, lesson_title, lesson_description, lesson_type, teacher_id, lesson_date,
                   start_time, end_time, module_id, link_lms, link_zoom, archived)
values (2, 'basic_programming/lesson_53',
        'Smalltalk about homework Questions Binary seek in arrays', 'CONSULTATION', 2, '2023-11-28',
        '10:15:30', '12:15:30', 1,
        'https://lms.ait-tr.de/#/group/cohort26/module/basic_programming/lesson/lesson_53',
        'https://us05web.zoom.us/j/82073564366?pwd=LqOp9ojsiqseacSVwFPyt2jZA2tqUI.1', false);
insert into lesson(group_id, lesson_title, lesson_description, lesson_type, teacher_id, lesson_date,
                   start_time, end_time, module_id, link_lms, link_zoom, archived)
values (1, 'basic_programming/lesson_54',
        'Smalltalk about homework Questions Binary seek in arrays', 'CONSULTATION', 1, '2023-11-29',
        '10:15:30', '12:15:30', 1,
        'https://lms.ait-tr.de/#/group/cohort26/module/basic_programming/lesson/lesson_54',
        'https://us05web.zoom.us/j/82073564366?pwd=LqOp9ojsiqseacSVwFPyt2jZA2tqUI.1', false);
insert into lesson(group_id, lesson_title, lesson_description, lesson_type, teacher_id, lesson_date,
                   start_time, end_time, module_id, link_lms, link_zoom, archived)
values (2, 'basic_programming/lesson_55',
        'Smalltalk about homework Questions Binary seek in arrays', 'CONSULTATION', 2, '2023-11-30',
        '10:15:30', '12:15:30', 1,
        'https://lms.ait-tr.de/#/group/cohort26/module/basic_programming/lesson/lesson_55',
        'https://us05web.zoom.us/j/82073564366?pwd=LqOp9ojsiqseacSVwFPyt2jZA2tqUI.1', false);
